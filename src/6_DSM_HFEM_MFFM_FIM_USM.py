#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time          : 2025/01/17 17:20
# @Author        : jcfszxc
# @Email         : jcfszxc.ai@gmail.com
# @File          : 6_DSM_HFEM_MFFM_FIM_USM.py
# @Description   : 
...
def cross_validate_model(X, y, class_labels=None, n_iterations=15):
    ...
    for fold, (train_idx, val_idx) in enumerate(skf.split(X, y), 1):
        ...
        # 6. 计算最终指标
        # fold_result = calculate_metrics(y_val, y_pred, y_pred, class_labels)
...
def save_results(results):
    ...
    output_file = output_dir / f'MASFI/DSM+HFEM+MFFM+FIM+USM_results_{timestamp}.json'
